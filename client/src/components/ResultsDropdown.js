  ...
  return (
    <div className='channel-search__results'>
      ...
      {loading && !teamChannels.length && (
        <p className='channel-search__results-header-loading'>
          <i>Loading...</i>
        </p>
      )}
      {!loading && !teamChannels.length ? (
        <p className='channel-search__results-header-notfound'>
      ...
      {!loading && !directChannels.length ? (
        <p className='channel-search__res ults-header-notfound'>
